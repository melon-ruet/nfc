...
class SearchViewCompatHoneycomb {
    ...
    final class C00741 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00741(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    final class C00752 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00752(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
