...
public class SearchViewCompat {
    ...
    class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C00721 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            C00721(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class C00732 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            C00732(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnCloseListener(OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C00732(onCloseListenerCompat));
        }

        public Object newOnQueryTextListener(OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C00721(onQueryTextListenerCompat));
        }
