...
public class ViewPropertyAnimatorCompat {
    ...
    class ICSViewPropertyAnimatorCompatImpl extends BaseViewPropertyAnimatorCompatImpl {
        ...
        class C00551 implements ViewPropertyAnimatorListener {
            final /* synthetic */ Runnable val$runnable;

            C00551(Runnable runnable) {
        ...
        class C00562 implements ViewPropertyAnimatorListener {
            final /* synthetic */ Runnable val$runnable;

            C00562(Runnable runnable) {
                this.val$runnable = runnable;
            }
        ...
        class C00573 implements ViewPropertyAnimatorListener {
        ...
        public void withEndAction(View view, Runnable runnable) {
            setListener(view, new C00551(runnable));
        }

        public void withLayer(View view) {
            setListener(view, new C00573(ViewCompat.getLayerType(view)));
        }

        public void withStartAction(View view, Runnable runnable) {
            setListener(view, new C00562(runnable));
        }
