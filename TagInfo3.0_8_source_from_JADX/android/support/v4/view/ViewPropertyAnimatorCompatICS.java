...
class ViewPropertyAnimatorCompatICS {
    ...
    final class C00581 extends AnimatorListenerAdapter {
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        view.animate().setListener(new C00581(viewPropertyAnimatorListener, view));
    }
    ...
    public static void m8x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m9y(View view, float f) {
        view.animate().y(f);
    }
