...
public class ViewPager extends ViewGroup {
    ...
    final class C00511 implements Comparator {
        C00511() {
        }
    ...
    final class C00522 implements Interpolator {
        C00522() {
        }
    ...
    public class SavedState extends BaseSavedState {
        ...
        final class C00541 implements ParcelableCompatCreatorCallbacks {
            C00541() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00541());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00511();
        sInterpolator = new C00522();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00533();
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        switch (keyEvent.getKeyCode()) {
            ...
            case C0086R.styleable.SherlockTheme_windowActionModeOverlay /*61*/:
