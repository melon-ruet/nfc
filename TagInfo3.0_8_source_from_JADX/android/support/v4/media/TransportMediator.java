...
public class TransportMediator extends TransportController {
    ...
    class C00261 implements TransportMediatorCallback {
        C00261() {
        }
    ...
    class C00272 implements Callback {
        C00272() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C00261();
        this.mKeyEventCallback = new C00272();
