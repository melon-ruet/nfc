...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00281 implements OnWindowAttachListener {
        C00281() {
        }
    ...
    class C00292 implements OnWindowFocusChangeListener {
        C00292() {
        }
    ...
    class C00314 implements OnAudioFocusChangeListener {
        C00314() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportMediatorCallback) {
        this.mWindowAttachListener = new C00281();
        this.mWindowFocusListener = new C00292();
        this.mMediaButtonReceiver = new C00303();
        this.mAudioFocusChangeListener = new C00314();
        this.mPlayState = 0;
