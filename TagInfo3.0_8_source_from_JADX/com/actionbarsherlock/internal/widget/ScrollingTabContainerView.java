...
public class ScrollingTabContainerView extends NineHorizontalScrollView implements OnItemSelectedListener {
    ...
    public class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    customView = new CapitalizingTextView(getContext(), null, C0086R.attr.actionBarTabTextStyle);
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0086R.styleable.SherlockActionBar, C0086R.attr.actionBarStyle, 0);
    ...
    private IcsSpinner createSpinner() {
        IcsSpinner icsSpinner = new IcsSpinner(getContext(), null, C0086R.attr.actionDropDownStyle);
    ...
    private IcsLinearLayout createTabLayout() {
        TabsLinearLayout tabsLinearLayout = (TabsLinearLayout) LayoutInflater.from(getContext()).inflate(C0086R.layout.abs__action_bar_tab_bar_view, null);
    ...
    private TabView createTabView(Tab tab, boolean z) {
        TabView tabView = (TabView) this.mInflater.inflate(C0086R.layout.abs__action_bar_tab, null);
    ...
    public void animateToTab(int i) {
        ...
        this.mTabSelector = new C01151(childAt);
