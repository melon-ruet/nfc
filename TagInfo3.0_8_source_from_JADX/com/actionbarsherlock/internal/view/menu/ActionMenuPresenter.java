...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    class OverflowMenuButton extends ImageButton implements View_HasStateListenerSupport, ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0086R.attr.actionOverflowButtonStyle);
    ...
    class SavedState implements Parcelable {
        ...
        final class C00981 implements Creator {
            C00981() {
            }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0086R.layout.abs__action_menu_layout, C0086R.layout.abs__action_menu_item_layout);
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(context, C0086R.integer.abs__max_action_buttons);
        }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(this.mContext, C0086R.integer.abs__max_action_buttons);
            if (this.mMenu != null) {
