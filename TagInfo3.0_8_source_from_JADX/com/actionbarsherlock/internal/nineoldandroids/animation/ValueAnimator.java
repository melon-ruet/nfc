...
public class ValueAnimator extends Animator {
    ...
    final class C00921 extends ThreadLocal {
        C00921() {
        }
    ...
    final class C00932 extends ThreadLocal {
        C00932() {
        }
    ...
    final class C00943 extends ThreadLocal {
        C00943() {
        }
    ...
    final class C00954 extends ThreadLocal {
        C00954() {
        }
    ...
    final class C00965 extends ThreadLocal {
        C00965() {
        }
    ...
    class AnimationHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            for (i = ValueAnimator.ANIMATION_START; i < size2; i += ValueAnimator.RUNNING) {
    ...
    static {
        ...
        sAnimations = new C00921();
        sPendingAnimations = new C00932();
        sDelayedAnims = new C00943();
        sEndingAnims = new C00954();
        sReadyAnims = new C00965();
    ...
    public void setFloatValues(float... fArr) {
        if (fArr != null && fArr.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                ...
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofFloat(BuildConfig.VERSION_NAME, fArr);
    ...
    public void setIntValues(int... iArr) {
        if (iArr != null && iArr.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofInt(BuildConfig.VERSION_NAME, iArr);
                setValues(propertyValuesHolderArr);
            } else {
    ...
    public void setObjectValues(Object... objArr) {
        if (objArr != null && objArr.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofObject(BuildConfig.VERSION_NAME, (TypeEvaluator) null, objArr);
                setValues(propertyValuesHolderArr);
            } else {
