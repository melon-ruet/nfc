...
public abstract class ActionBar {
    ...
    public class LayoutParams extends MarginLayoutParams {
        ...
        static {
            int[] iArr = new int[ActionBar.NAVIGATION_MODE_LIST];
            iArr[ActionBar.NAVIGATION_MODE_STANDARD] = 16842931;
            ATTRS = iArr;
        }
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = obtainStyledAttributes.getInt(ActionBar.NAVIGATION_MODE_STANDARD, -1);
